...
(function (task7) {
    task7.product = {
        "Anrichtung": [
            { type: "radio", name: "Anrichtung", price: 0.50, value: 0, id: "radio1", class: "Waffel", minimum: 0, maximum: 0 },
        ...
        "Extras": [
            { type: "checkbox", name: "Extras", price: 0.50, value: 0, id: "check1", class: "Streusel", minimum: 0, maximum: 0 },
            { type: "checkbox", name: "Extras", price: 0.50, value: 0, id: "check2", class: "Schokosoße", minimum: 0, maximum: 0 },
            { type: "checkbox", name: "Extras", price: 0.50, value: 0, id: "check3", class: "Karamelsoße", minimum: 0, maximum: 0 },
            { type: "checkbox", name: "Extras", price: 0.50, value: 0, id: "check4", class: "Sahne", minimum: 0, maximum: 0 }
        ]
    };
    /* = {
    "sorten": [
