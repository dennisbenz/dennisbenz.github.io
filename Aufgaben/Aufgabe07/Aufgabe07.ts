namespace task7 {
    ...
    function checkButton(): void {
        let button1: HTMLButtonElement = <HTMLButtonElement>document.getElementById("checkButton");
        button1.addEventListener("click", pruefungDerDaten);
    }

    function sendButton(_event: Event): void {
        let button2: HTMLButtonElement = <HTMLButtonElement>document.getElementById("sendButton");
    ...
    let urlAddress: string = "https://benzeia2.herokuapp.com/";
